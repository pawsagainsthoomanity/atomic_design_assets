...
(function(){
	...
	var navLink = document.querySelectorAll('.ads-js-nav-dropdown-trigger'); /* 1 */
	 ...
	 */
	var navToggle = document.querySelectorAll('.ads-js-nav-trigger');/* 1 */
	...
	for (i=0; i<navToggle.length; i++) { /* 1 */
		...
		navToggle[i].addEventListener('click',function(event){ /* 2 */
	        ...
	        var navPanel = navToggleParent.querySelector('.ads-js-nav-panel'); /* 2 */

	        if (navPanel.classList.contains('ads-is-active')) { /* 3 */
	            navPanel.classList.remove('ads-is-active');
	        }
	        else { /* 4 */
	            navPanel.classList.add('ads-is-active');
	        }
		});
	}
